...
(function initSettingsPanel() {
  ...
  const SettingsPanel = defineComponent({
    ...
    <aside
      ...
      ref="panel"
      :class="[ 
        'z-[99999] flex-col absolute bottom-0 lg:top-0 right-0 h-screen md:h-auto lg:h-full mobile-landscape:h-screen w-full lg:w-40 lg:relative lg:flex  bg-black/50 shadow-[0_0_6.776px_0_rgba(0,0,0,0.25)] rounded-0 md:rounded-[1.0rem] lg:!rounded-[1.0rem] backdrop-blur-[25px] lg:backdrop-blur-none overflow-y-auto transition-transform duration-300 ease-in-out',
    ...
    >
      ...
      >
        <img
          data-sidebar-close
          src="https://new-stage.fansocial.app/wp-content/plugins/fansocial/dev/chimenew/assets/svgs/x.svg"
